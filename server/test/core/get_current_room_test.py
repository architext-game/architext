...
def test_get_current_room_success(architext: Architext):
    result: GetCurrentRoomResult = architext.handle(GetCurrentRoom(), client_user_id="0")
...
def test_get_current_room_user_not_in_room(architext: Architext):
    result: GetCurrentRoomResult = architext.handle(GetCurrentRoom(), client_user_id="1")
