...
from architext.core.queries.get_current_room_details import GetCurrentRoomDetails, UOWGetCurrentRoomDetailsQueryHandler
...
def uow_query_handlers_factory(uow: UnitOfWork) -> Mapping[Type[Query], QueryHandler]:
    return {
        ...
        GetCurrentRoomDetails: UOWGetCurrentRoomDetailsQueryHandler(uow),
    }
