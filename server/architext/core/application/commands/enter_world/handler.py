from architext.core.application.commands.enter_world.command import EnterWorld, EnterWorldResult
...
def enter_world(uow: UnitOfWork, command: EnterWorld, client_user_id: str) -> EnterWorldResult:
    with uow as transaction:
        ...
        initial_room = transaction.rooms.get_room_by_id(room_to_enter_id)
