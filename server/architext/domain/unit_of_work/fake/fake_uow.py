...
from architext.domain.unit_of_work.fake.notification_adapter import FakeNotificationAdapter
...
class FakeUnitOfWork(UnitOfWork):
    def __init__(self, messagebus: MessageBus = MessageBus()):
        ...
        self.notifications: FakeNotificationAdapter = FakeNotificationAdapter()
