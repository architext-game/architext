    ...
    def process(self, message):
        ...
        if topic is None:
            ...
            out = _(
                ...
                '  addkey <exit> ─ to assign a key to the exit.\n'
                '  masteropen <exit> ─ to open an exit without the need of a key.\n'
                '  removekey <exit> ─ to delete a previously assigned key.\n'
                '\n'
                'Custom verbs\n'
                '────────────\n'
            ...
            out = _(
                ...
                '  textto <user> - <text> ─ sends the text to the selected user (the "-" is important!) \n'
                '\n'
                'Other verbs\n'
                '───────────\n'
